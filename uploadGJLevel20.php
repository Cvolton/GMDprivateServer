...
$levelName = explode("(", explode(";", explode(":", htmlspecialchars($_POST["levelName"],ENT_QUOTES))[0])[0])[0];
$levelDesc = explode("(", explode(";", explode(":", htmlspecialchars($_POST["levelDesc"],ENT_QUOTES))[0])[0])[0];
$levelVersion = explode("(", explode(";", explode(":", htmlspecialchars($_POST["levelVersion"],ENT_QUOTES))[0])[0])[0];
$levelLength = explode("(", explode(";", explode(":", htmlspecialchars($_POST["levelLength"],ENT_QUOTES))[0])[0])[0];
$audioTrack = explode("(", explode(";", explode(":", htmlspecialchars($_POST["audioTrack"],ENT_QUOTES))[0])[0])[0];
$auto = explode("(", explode(";", explode(":", htmlspecialchars($_POST["auto"],ENT_QUOTES))[0])[0])[0];
$password = explode("(", explode(";", explode(":", htmlspecialchars($_POST["password"],ENT_QUOTES))[0])[0])[0];
$original = explode("(", explode(";", explode(":", htmlspecialchars($_POST["original"],ENT_QUOTES))[0])[0])[0];
$twoPlayer = explode("(", explode(";", explode(":", htmlspecialchars($_POST["twoPlayer"],ENT_QUOTES))[0])[0])[0];
$songID = explode("(", explode(";", explode(":", htmlspecialchars($_POST["songID"],ENT_QUOTES))[0])[0])[0];
$objects = explode("(", explode(";", explode(":", htmlspecialchars($_POST["objects"],ENT_QUOTES))[0])[0])[0];
$coins = explode("(", explode(";", explode(":", htmlspecialchars($_POST["coins"],ENT_QUOTES))[0])[0])[0];
$requestedStars = explode("(", explode(";", explode(":", htmlspecialchars($_POST["requestedStars"],ENT_QUOTES))[0])[0])[0];
$extraString = explode("(", explode(";", explode(":", htmlspecialchars($_POST["extraString"],ENT_QUOTES))[0])[0])[0];
$levelString = explode("(", explode(";", explode(":", htmlspecialchars($_POST["levelString"],ENT_QUOTES))[0])[0])[0];
$levelInfo = explode("(", explode(";", explode(":", htmlspecialchars($_POST["levelInfo"],ENT_QUOTES))[0])[0])[0];
$secret = explode("(", explode(";", explode(":", htmlspecialchars($_POST["secret"],ENT_QUOTES))[0])[0])[0];
$accountID = "";
$id = explode("(", explode(";", explode(":", htmlspecialchars($_POST["udid"],ENT_QUOTES))[0])[0])[0];
if($_POST["accountID"]!=""){
