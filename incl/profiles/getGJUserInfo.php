...
//var_dump($leaderboard);
	//accinfo
		$query = "SELECT youtubeurl,twitter,twitch,discord,instagram,tiktok,custom, frS, mS, cS FROM accounts WHERE accountID = :extID";
		$query = $db->prepare($query);
		$query->execute([':extID' => $extid]);
		$accinfo = $query->fetch();
