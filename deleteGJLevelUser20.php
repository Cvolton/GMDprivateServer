...
$levelID = explode(";", htmlspecialchars($_POST["levelID"],ENT_QUOTES);
$accountID = explode(";", htmlspecialchars($_POST["accountID"],ENT_QUOTES);
$gjp = explode(";", htmlspecialchars($_POST["gjp"],ENT_QUOTES);
