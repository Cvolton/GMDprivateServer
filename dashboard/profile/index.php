...
if($res["stars"] == 0) $st = ''; else $st = '<p class="profilepic">'.$res["stars"].' <i class="fa-solid fa-star" style="color:#ffff5b"></i></p>';
if($res["moons"] == 0) $ms = ''; else $ms = '<p class="profilepic">'.$res["moons"].' <i class="fa-solid fa-moon" style="color:#244689"></i></p>';
if($res["diamonds"] == 0) $dm = ''; else $dm = ' <p class="profilepic">'.$res["diamonds"].' <i class="fa-solid fa-gem" style="color:#537dd1"></i></p>';
if($res["coins"] == 0) $gc = ''; else $gc = '<p class="profilepic">'.$res["coins"].' <i class="fa-solid fa-coins" style="color:#fae502"></i></p>';
if($res["userCoins"] == 0) $uc = ''; else $uc = '<p class="profilepic">'.$res["userCoins"].' <i class="fa-solid fa-coins"></i></p>';
if($res["demons"] == 0) $dn = ''; else $dn = '<p class="profilepic">'.$res["demons"].' <i class="fa-solid fa-dragon" style="color:#c81003"></i></p>';
...
if($res["creatorPoints"] == 0) $cp = ''; else $cp = '<p class="profilepic" '.$banhaha.'>'.$res["creatorPoints"].' <i class="fa-solid fa-screwdriver-wrench"  style="color:#7f7f7f" '.$creatorban.'></i></p>';
