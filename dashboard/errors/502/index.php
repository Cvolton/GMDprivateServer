...
$path =  str_replace('/errors/502/index.php', '', $path);
include $_SERVER['DOCUMENT_ROOT'].''.$path.'/../config/dashboard.php';
if($_COOKIE["lang"] == 'RU') $text = 'Сервер лёг!'; else $text = 'Server is down!';
echo '<title>502 | '.$gdps.'</title>
<a href="'.$path.'"><p class="error">502</p></a>
