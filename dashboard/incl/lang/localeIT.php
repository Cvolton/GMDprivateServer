...
$string["reuploadBTN"] = "Caricamento";
...
$string["renamedSong"] = "Hai rinominato correttamente il brano in";
...
$string["date"] = "Data";
$string["type"] = "Tipo";
$string["reportCount"] = "Conteggio dei rapporti";
$string["reportMod"] = "Rapporti";
...
$string["levelpass"] = "Parola d'ordine";
$string["nopass"] = "Nessuna parola d'ordine";
...
$string["playerTop"] = 'La classifica dei giocatori';
$string["creatorTop"] = 'La classifica dei creatori';
...
$string["elder"] = "Moderatore anziano";
$string["moder"] = "Moderatore";
$string["player"] = "Giocatore";

$string["starsLevel2"] = "stelle";
$string["starsLevel1"] = "stelle";
$string["starsLevel0"] = "stella";
$string["coins2"] = "monete";
$string["coins1"] = "monete";
$string["coins0"] = "moneta";
$string["time0"] = "volta";
$string["time1"] = "volte";
$string["times"] = "volte";
$string["action0"] = "azione";
$string["action1"] = "azioni";
$string["action2"] = "azioni";
$string["lvl0"] = "livello";
$string["lvl1"] = "livelli";
$string["lvl2"] = "livelli";
$string["player0"] = "giocatore";
$string["player1"] = "giocatori";
$string["player2"] = "giocatori";
$string["unban"] = "Sbanna";
$string["isBan"] = "Banna";
...
$string["modAction9"] = "Password di livello modificata";
$string["modAction10"] = "Difficoltà del demone modificata";
$string["modAction11"] = "CP condiviso";
$string["modAction12"] = "Livello non pubblicato/pubblicato";
...
$string["dashboard"] = "Pannello di controllo";
