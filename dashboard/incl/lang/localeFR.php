...
$string['uploading'] = 'Publier';
$string['commenting'] = 'Commenter';
$string['leaderboardSubmits'] = 'Soumissions sur le(s) classement(s)';
...
$string['disableLevelsLeaderboardSubmits'] = 'Désactiver la soumissions de records sur les classements de ces niveaux';
$string['disable'] = 'Désactiver';
$string['enable'] = 'Activer';
$string['registering'] = 'Inscription';
$string['accountPosting'] = 'Publier des posts';
$string['updatingProfileStats'] = 'Mettre à jour les stats de profil';
$string['messaging'] = 'Envoyer des messages';
