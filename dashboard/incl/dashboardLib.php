				...
				<ul class="nav navbar-nav ml-auto">';
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
							...
							<a class="dropdown-item dontblock" href="lang/switchLang.php?lang=ID" title="Translated by IHNGEYMING"><div class="icon flag"><img class="imgflag" src="incl/flags/id.png?2"></div>Indonesian</a>
						</div>';
