...
if(isset($_POST["name"]) AND isset($_POST["desc"]) AND isset($_POST["color"])) {
        $name = base64_encode(ExploitPatch::remove(str_replace(' ', '', $_POST["name"]), 20));
        $desc = base64_encode(ExploitPatch::remove($_POST["desc"], 255));
        $color = ExploitPatch::remove(mb_substr($_POST["color"], 1), 6);
