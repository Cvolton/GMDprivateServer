...
$x = 1;
$packtable = "";
$query = $db->prepare("SELECT * FROM lists WHERE unlisted != 0 AND accountID = :accID ORDER BY listID DESC LIMIT 10 OFFSET $page");
...
$dl->printPage('<div class="form new-form"><h1>'.$dl->getLocalizedString('listTableYour').'</h1>
