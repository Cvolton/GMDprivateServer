...
foreach($result as &$action) {
	...
	if($action["stars"] == 0) $st = ''; else $st = '<p class="profilepic">'.$action["stars"].' <i class="fa-solid fa-star" style="color:#ffff5b"></i></p>';
    	if($action["moons"] == 0) $ms = ''; else $ms = ' <p class="profilepic">'.$action["moons"].' <i class="fa-solid fa-moon" style="color:#244689"></i></p>';
    	if($action["diamonds"] == 0) $dm = ''; else $dm = ' <p class="profilepic">'.$action["diamonds"].' <i class="fa-solid fa-gem" style="color:#537dd1"></i></p>';
    	if($action["coins"] == 0) $gc = ''; else $gc = '<p class="profilepic">'.$action["coins"].' <i class="fa-solid fa-coins" style="color:#fae502"></i></p>';
    	if($action["userCoins"] == 0) $uc = ''; else $uc = '<p class="profilepic">'.$action["userCoins"].' <i class="fa-solid fa-coins"></i></p>';
   	if($action["demons"] == 0) $dn = ''; else $dn = '<p class="profilepic">'.$action["demons"].' <i class="fa-solid fa-dragon" style="color:#c81003"></i></p>';
    	if($action["creatorPoints"] == 0) $cp = ''; else $cp = '<p class="profilepic">'.$action["creatorPoints"].' <i class="fa-solid fa-screwdriver-wrench" style="color:#7f7f7f"></i></p>';
