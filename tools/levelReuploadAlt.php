...
$uploadDate = time();
$query = $db->prepare("INSERT INTO levels (levelName, gameVersion, binaryVersion, userName, levelDesc, levelVersion, levelLength, audioTrack, auto, password, original, twoPlayer, songID, objects, coins, requestedStars, extraString, levelString, levelInfo, secret, uploadDate, starDifficulty, starDemon, starAuto, starStars, starFeatured, userID)
VALUES ('$resultarray[3]','20', '27', 'Cvolton', '$resultarray[5]', '$resultarray[9]', '$resultarray[35]', '$resultarray[21]', '0', '1337666', '0', '$resultarray[39]', '$resultarray[45]', '0', '$resultarray[49]', '$resultarray[53]', '$resultarray[47]', '$resultarray[7]', '0', '0', '1435242585', '$resultarray[15]', '$resultarray[27]', '$resultarray[29]', '$resultarray[31]', '$resultarray[33]', '1')");
$query->execute();
