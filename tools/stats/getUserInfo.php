...
if (!empty($_GET['u']))
{
	...
	$c = count($users);
	echo "<p>Count: $c</p>";	
	echo '<table border=1><tr><th>UserName</th><th>UserID</th><th>Stars</th><th>Is Banned</th><th>Ban Reason</th><th>AccountID</th></tr>';
	foreach ($users as &$user)
	{
		...
		echo "<tr><td>$un</td><td>$id</td><td>$st</td><td>$ib</td><td>$reason</td><td>$ac</td></tr>";
	}
	echo '</table>';
}
